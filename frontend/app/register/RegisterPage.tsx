...
import { Activity, Target, ShieldCheck, Mail, Lock, User, ChevronDown } from "lucide-react";
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-[#40798C] text-[#F2F7F2] h-14 flex items-center justify-center gap-3 rounded-2xl font-bold text-sm hover:bg-[#1F363D] hover:text-white shadow-lg shadow-[#40798C]/10 transition-all active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer tracking-widest uppercase"
                >
                  {loading && (
