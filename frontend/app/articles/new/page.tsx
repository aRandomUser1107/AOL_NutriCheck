...
export default function NewArticlePage() {
  ...
  // hooks for form state and user info
  ...
  async function publish() {
    if (nutritionistId === null) {
      setError("Unable to publish: nutritionist information is missing.");
      return;
    }
    ...
    try {
      await apiFetch(`/api/articles?nutritionist_id=${nutritionistId}`, {
        method: "POST",
      ...
      setError(
        err instanceof Error ? err.message : "Unable to publish article.",
      );
    } finally {
      setSaving(false);
    }
  ...
  useEffect(() => {
    setUserRole(getRole());
    setNutritionistId(getNutritionistId());
  }, []);
