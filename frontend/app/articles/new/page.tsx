...
export default function NewArticlePage() {
  ...
  async function publish() {
    ...
    try {
      const article = await apiFetch(`/api/articles/?nutritionist_id=${NUTRITIONIST_ID}`, {
        method: "POST",
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.topBar}>
          ...
          <div className={styles.topActions}>
            ...
            >
              {saving ? <><span className={styles.spinner} />Publishing...</> : "Publish Article"}
            </button>
          </div>
        </div>
        ...
        <div className={`card ${styles.editorCard}`}>
          <div className={styles.editorHeader}>
            <span className={styles.authorTag}>Writing as Nutritionist{NUTRITIONIST_ID}</span>
          </div>
